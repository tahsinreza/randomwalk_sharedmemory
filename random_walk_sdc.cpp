...
int main(int argc, char** argv) {
  ...
  // Test
  //for (Vertex v = 0; v < vertex_count; v++) {
  //  if (vertex_data[v] != 519353457214661108 && 
  //    vertex_data[v] != 756880090378066622) {
  ...
  typedef random_walk<Vertex, Edge, VertexList, VertexDataList, EdgeList, 
    uint64_t> RandomWalk;
  RandomWalk rw(walker_count, walker_hop_count, host_thread_count); 
  rw.do_random_walk(vertices, vertex_degree, vertex_data, edges, 
    walks_output_filename);
